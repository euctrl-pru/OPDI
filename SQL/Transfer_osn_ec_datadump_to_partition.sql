DROP TABLE osn_ec_datadump_bucketed;
CREATE TABLE osn_ec_datadump_bucketed (
...
INSERT OVERWRITE TABLE project_aiu.osn_ec_datadump_bucketed 
SELECT * FROM project_aiu.osn_ec_datadump LIMIT 100000000;
