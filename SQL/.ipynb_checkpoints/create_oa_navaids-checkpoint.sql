CREATE TABLE oa_navaids (
  ...
  elevation_ft INT COMMENT 'The navaid\'s elevation MSL in feet (not metres).',
  ...
  dme_elevation_ft INT COMMENT 'The associated DME transmitters elevation MSL in feet. If missing, assume that it\'s the same value as elevation_ft.',
  slaved_variation_deg DOUBLE COMMENT 'The magnetic variation adjustment built into a VOR\'s, VOR-DME\'s, or TACAN\'s radials.',
  magnetic_variation_deg DOUBLE COMMENT 'The actual magnetic variation at the navaid\'s location.',
...
COMMENT 'OurAirports airport naivaid\'s data (for PRU) - Monthly updated.'
STORED AS parquet
