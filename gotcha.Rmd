...
pick_edges <- pick_trj |> cast_prev_next_to_ls() |> 
  select(UID, geometry)
```
...
data prep
* read in NM traj & interpolate 5sec 
* create meta flt ==> UID, FLTID, DOF, RFL from flight table

```{r}
fn <- "./data/3Di_042023.csv"
