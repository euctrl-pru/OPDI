...
oa_airport_frequencies_sql = f"""
    DROP TABLE IF EXISTS `project_aiu`.`oa_airport_frequencies`;
...
oa_airports_sql = f"""
    DROP TABLE IF EXISTS `project_aiu`.`oa_airports`;
...
oa_countries_sql = f"""
    DROP TABLE IF EXISTS `project_aiu`.`oa_countries`;
...
oa_navaids_sql = f"""
    DROP TABLE IF EXISTS `project_aiu`.`oa_navaids`;
...
oa_regions_sql = """
    DROP TABLE IF EXISTS `project_aiu`.`oa_regions`;
...
oa_runways_sql = """
    DROP TABLE IF EXISTS `project_aiu`.`oa_runways`;
