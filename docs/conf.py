...
# -- Path setup --------------------------------------------------------------
# Add the src directory so autodoc can find the opdi package.
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/euctrl-pru/opdi",
            "html": (
...
# -- Create _static directory if it does not exist ---------------------------
